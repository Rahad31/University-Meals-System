...
const Footer = () => {
  return (
    <div>
      <footer className=" rounded-md footer footer-center p-10 mt-20  bg-slate-200 text-">
        <aside>
          <img
          ...
          <p className="font-bold text-center ">
            <span className="text-[#EAA334] text-2xl">UNI MEAL </span> <br />
            <div>Providing reliable Service since 2012</div>{" "}
            <div>MBSTU,TANGAIL</div>
